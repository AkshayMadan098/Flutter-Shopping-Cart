...
import 'package:flutter_shopping_cart/provider/cart_provider.dart';
import 'package:flutter_shopping_cart/helper/db_helper.dart';
            ...
            Consumer<CartProvider>(builder: (context, value, child){
              return Visibility(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      PriceWidget(title: 'Sub Total', value: r'$'+value.getTotalPrice().toStringAsFixed(2),),
                      PriceWidget(title: 'Discout 5%', value: r'$'+'20',),
                      PriceWidget(title: 'Total', value: r'$'+value.getTotalPrice().toStringAsFixed(2),),
                      Container(
                        height: 50,
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            _toastInfo("Succesfully purchased");
                          },
                          color: Colors.blue,
                        ),
                      )
...
class PriceWidget extends StatelessWidget {
  ...
  const PriceWidget({required this.title, required this.value});
